...
import { useGetRecipeByAreaQuery } from '../features/api/recipeApiSlice';

const AllFoodByArea = () => {
  const { area } = useParams();
  const {data, isLoading, error}= useGetRecipeByAreaQuery(area)
  ...
  return (
    <div className='pt-[150px]'>
      <Container>
        <h1 className='text-primary font-secondary font-bold border-b text-center mb-10 text-[50px]'>All Recipes of {area}</h1>
